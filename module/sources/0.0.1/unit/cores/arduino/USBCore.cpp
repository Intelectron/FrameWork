...
#define USB_PRODUCT     "Infineo USB IO"
#endif

const u8 STRING_PRODUCT[] PROGMEM = USB_PRODUCT;

#  define USB_MANUFACTURER "Intelectron India"

#if !defined(USB_MANUFACTURER)
#  define USB_MANUFACTURER "intelectron.in" // Fall through to unknown if no manufacturer name was provided in a macro
#endif
...
const DeviceDescriptor USB_DeviceDescriptor =
	D_DEVICE(0x00,0x00,0x00,64,0x1209,0x9999,0x100,IMANUFACTURER,IPRODUCT,ISERIAL,1);
